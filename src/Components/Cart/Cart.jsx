...
const Cart = ({book}) => {
    const {Title, Image, Category1, Category2, Author, Book_Type, Ratings, Star} = book;
        ...
        <div className="border p-6 rounded-[16px]">
            <div>
                ...
                <div className="flex items-center pt-6 gap-4">
                    <span className="text-[#23BE0A] sans text-base font-normal px-4 bg-[#23BE0A0D] rounded-xl text-center py-[2px]">{Category1}</span> <span className="text-[#23BE0A] sans text-base font-normal px-4 bg-[#23BE0A0D] py-[2px] rounded-xl">{Category2}</span>
                </div>

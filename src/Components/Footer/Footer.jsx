...
const Footer = () => {
    return (
        <div>
        <footer id="footer" className="footer footer-center p-10 bg-gray-700 text-primary-content">
            <aside>
                ...
                Book Vibe Publications <br/>Producing all category of books since 1992
                </p> 
